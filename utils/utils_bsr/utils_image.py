...
#     pool = Pool(16)
#     pool.apply_async(split_imageset, args=("ost", "trainH2", 3, 800, 200, 1000))
#     pool.close()
#     pool.join()


#    split_imageset('trainH2','trainH',p_size=800, p_overlap=200, p_max=1000)
#    split_imageset('trainH','trainH2', p_size=800, p_overlap=96, p_max=1000)
...
#               # img = imread_uint(fname, n_channels=3)
#                img = cv2.imread(fname)
#
#                if img.shape[0]>288 and img.shape[1]>288:
#                    blur_threshold=105
#
...
#                        imwrite(img,'ost/ost_'+img_name+'.png')
##
##


#                print(img.shape)
#    img = imread_uint('b.png',3)


#    c1 = 0
#    paths = get_image_paths('../datasets/trainH320')
#    cal= len(paths)
#    for img_path in paths:
#        img_name, ext = os.path.splitext(os.path.basename(img_path))
#        img = imread_uint(img_path, n_channels=3)
#        w,h,c=img.shape
#        if w<320 or h<320:
#            os.remove(img_path)
##        if w>=320 and h>=320:
##            imsave(img, os.path.join('trainH320',img_name+'.png'))
##        else:
#            c1+=1
#            print(c1)
#            print(img_path)
##            print('{}x{}--{}--{}/{}'.format(w,h,img_path,c1,cal))
##


#    strs = []
#    for i in range(800, 901):
#        strs.append(str(i).zfill(4))
#        strs.append(str(i).zfill(4)+'x2')
#        strs.append(str(i).zfill(4)+'x3')
#        strs.append(str(i).zfill(4)+'x4')
#
